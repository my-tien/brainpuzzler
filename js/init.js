...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: '{{ "/css/style.css" | prepend: site.baseurl }}', containers: 1440, viewport: { scalable: false }, grid: { gutters: 40 } },
			'wide': { range: '-1920', href: '{{ "/css/style-wide.css" | prepend: site.baseurl }}', containers: 1360 },
			'normal': { range: '-1680', href: '{{ "/css/style-normal.css" | prepend: site.baseurl }}', containers: 1200 },
			'narrow': { range: '-1280', href: '{{ "/css/style-narrow.css" | prepend: site.baseurl }}', containers: 960 },
			'narrower': { range: '-1000', href: '{{ "/css/style-narrower.css" | prepend: site.baseurl }}', containers: '95%' },
			'mobile': { range: '-736', href: '{{ "/css/style-mobile.css" | prepend: site.baseurl }}', grid: { gutters: 20 } },
